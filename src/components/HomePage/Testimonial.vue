    ...
    <div class="container px-5 py-12 mx-auto">
      <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
        <svg
          ...
          fill="#d1a160"
          class="inline-block w-8 h-8 custom-color-secondary mb-8"
        ...
        <span
          class="inline-block h-1 w-10 rounded custom-bg-secondary mt-8 mb-6"
        ></span>
        <h2
          class="custom-color-secondary font-medium title-font tracking-wider text-sm"
        >
          HOLDEN CAULFIELD
        </h2>
