    ...
    <div class="container px-5 lg:px-0 mx-auto">
      <div class="lg:w-4/5 mx-auto flex flex-wrap">
        ...
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <h1
            class="custom-color-secondary text-3xl title-font font-medium mb-1"
          >
            {{ product?.name }}
          </h1>
          <div class="flex mb-4">
          ...
          >
            <div class="flex items-center">
              ...
              <div class="relative">
                <select
                  v-on:change="handleAmountSelect($event)"
                  class="
                    rounded
                    border
                    appearance-none
...
export default {
  ...
  async beforeMount() {
    ...
    if (productManager.products && productManager.products.length > 0) {
      this.product = productManager.products.find(
        (product) => product.id == routeId
      );
      this.price = productManager.products.find(
        (product) => product.id == routeId
      ).price;
    } else {
